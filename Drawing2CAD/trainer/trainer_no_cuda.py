...
class TrainerED(BaseTrainer):
    def build_net(self, cfg):
        ...
        self.net = SVG2CADTransformer(cfg)
    ...
    def set_loss_function(self):
        ...
        self.loss_func = NewCADLoss(self.cfg)
    ...
    def forward(self, data):
        ...
        svg_view = svg_data['view']
        # svg_command = svg_data['command'].cuda() 
        svg_command = svg_data['command']
        # svg_args = svg_data['args'].cuda()
        svg_args = svg_data['args']
    ...
    def logits2vec(self, outputs, refill_pad=True, to_numpy=True):
        ...
        if refill_pad: # fill all unused element to -1
            ...
            mask = ~torch.tensor(CAD_CMD_ARGS_MASK).bool()[out_command.long()]
            out_args[mask] = -1
