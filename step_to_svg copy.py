...
def project_step_to_svg(step_path, output_dir):
    ...
    #     "iso":   gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(1, -1, -1), gp_Dir(0, 1, -1))
    # }
    #trail2 - working
    # views = {
    #     "front": gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(0, 1, 0), gp_Dir(0 , 0, 1)),
    ...
    #     "iso":   gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(1, 1, 1), gp_Dir(0, -1, 1))
    # }
    #trail 4 2nd rotation - working
    views = {
        "front": gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(0, 0, 1), gp_Dir(1, 0, 0)),
        "right": gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(1, 0, 0), gp_Dir(0, 0, -1)),
        "top":   gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(0, 1, 0), gp_Dir(1, 0, 0)),
        "iso":   gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(1, 1, 1), gp_Dir(1, 0, -1))
    }

    # Views after 1 transition
    # views = {
    #     "front": gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(0, 1, 0), gp_Dir(0, 0, -1)),
    #     "right": gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(0, 0, -1), gp_Dir(0, -1, 0)),
    #     "top":   gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(-1, 0, 0), gp_Dir(0, 0, -1)),
    ...
    #working
    # views = {
    #     "front": gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(1, 0, 0), gp_Dir(0, 0, 1)),
    #     "right": gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(0, 0, 1), gp_Dir(-1, 0, 0)),
    #     "top":   gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(0, -1, 0), gp_Dir(0, 0, 1)),
    #     "iso":   gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(1, -1, 1), gp_Dir(-1, 0, 1))
    # }

    # Views after 2 transitions
    # views = {
    #     "front": gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(0, 0, -1), gp_Dir(1, 0, 0)),
    #     "right": gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(1, 0, 0), gp_Dir(0, 0, 1)),
    #     "top":   gp_Ax2(gp_Pnt(0, 0, 0), gp_Dir(0, -1, 0), gp_Dir(1, 0, 0)),
